...
export default function Footer() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between px-8 md:px-36 bg-neutral-100 text-neutral-600 p-8 space-x-0 md:space-x-12">
      <div className="mb-12 md:mb-0">
        ...
        <div className="flex space-x-6 ">
          <input
            ...
            className="py-4 px-6 bg-neutral-600/20 rounded-xl"
          />
      ...
      <div className="flex items-start justify-between w-full md:w-[50%]">
        <div className="flex flex-col items-start justify-start">
          <h4 className="text-xl font-medium text-black">Health Matrix</h4>
          <p>About Us</p>
          <p>Our Team</p>
          <p>Careers</p>
          <p>Blog</p>
        ...
        <div className="flex flex-col items-start justify-start">
          <h4 className="text-xl font-medium text-black">For Doctors</h4>
          <p>lorem ipsum</p>
          <p>lorem ipsum</p>
          <p>lorem ipsum</p>
          <p>lorem ipsum</p>
